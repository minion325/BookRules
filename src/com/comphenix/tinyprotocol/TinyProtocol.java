...
public abstract class TinyProtocol {
    ...
    private static final MethodInvoker getPlayerHandle = Reflection.getMethod("org.bukkit.craftbukkit." + VERSION + ".entity.CraftPlayer", "getHandle");
    private static final FieldAccessor<Object> getConnection = Reflection.getField("net.minecraft.server." + VERSION + ".EntityPlayer", "playerConnection", Object.class);
    private static final FieldAccessor<Object> getManager = Reflection.getField("net.minecraft.server." + VERSION + ".PlayerConnection", "networkManager", Object.class);
    private static final FieldAccessor<Channel> getChannel = Reflection.getField("net.minecraft.server." + VERSION + ".NetworkManager", Channel.class, 0);

    // Looking up ServerConnection
    private static final Class<Object> minecraftServerClass = Reflection.getUntypedClass("net.minecraft.server." + VERSION + ".MinecraftServer");
    private static final Class<Object> serverConnectionClass = Reflection.getUntypedClass("net.minecraft.server." + VERSION + ".ServerConnection");
    private static final FieldAccessor<Object> getMinecraftServer = Reflection.getField("org.bukkit.craftbukkit." + VERSION + ".CraftServer", minecraftServerClass, 0);
